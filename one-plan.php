...
<title>Tufts Medicare Preferred Supplement One Plan</title>
<!-- InstanceEndEditable -->
...
<h1><!-- InstanceBeginEditable name="Page Header" -->Learn<!-- InstanceEndEditable --></h1>
</div>
</div>
...
<!-- InstanceBeginEditable name="Content" -->
    ...
    <p>Tufts Medicare Preferred Supplement One plan provides all the benefits of our Core plan &ndash; PLUS 100% payment of Part A (hospital) and Part B (medical) deductibles, skilled nursing facility copays and more. It does not include prescription drug benefits.</p>
        ...
        <ul>
          ...
          <li>You&rsquo;ll enjoy personal service from a local plan with a national reputation for excellence</li>
          <li>Worldwide emergency coverage </li>
        </ul>
        <h4>Tufts Medicare Preferred Supplement One plan covers everything offered by our Core plan:</h4>
        <ul>
          <li>Medicare&rsquo;s copay for covered hospitalization from the 61st day to 90th day</li>
          <li>Medicare&rsquo;s copay for covered hospitalization from the 91st day on – when using your 60 lifetime reserve days</li>
          <li>Medicare&rsquo;s Part B coinsurance for Part B eligible expenses after deductible is met</li>
          <li>No exclusion for hospital stays that begin prior to your Plan&rsquo;s effective date</li>
        </ul>
        <h4>And much, much more. The plan pays:</h4>
        <ul>
          <li>Medicare&rsquo;s Part A Hospital and Part B Medical deductibles</li>
          <li>Skilled Nursing copays from the 21st day to 100th day of benefit period</li>
        </ul>
        <h4>Residency Requirement</h4>
        <p>You must reside in Massachusetts for at least 6 consecutive months to join this plan.
          <?php require_once('inc/footnote1.php'); ?>
        </p>
<!-- InstanceEndEditable -->
<div class="bottom_components"><!-- InstanceBeginEditable name="Bottom Callouts" --><!-- InstanceEndEditable --></div>
</div>
