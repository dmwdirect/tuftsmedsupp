...
<!-- InstanceEndEditable -->
<!-- InstanceParam name="bodyclass" type="text" value="bg_sub about" -->
...
<h1><!-- InstanceBeginEditable name="Page Header" -->About <br>
  Tufts Health Plan <!-- InstanceEndEditable --></h1>
</div>
</div>
...
<!-- InstanceEndEditable -->
  ...
  <!-- InstanceBeginEditable name="Secondary Callouts" --><!-- InstanceEndEditable --></div>
<div class="left2col pull-left">
  <h2><!-- InstanceBeginEditable name="Headline" -->A national reputation for excellence you can trust<!-- InstanceEndEditable --></h2>
...
<p>Tufts Health Plan, through our philosophy, our people and our innovation, offers you a local health plan with a national reputation for excellence. </p>
<ul>
  <li>One of the nation&rsquo;s most highly rated health plans</li>
  <li>A not-for-profit health maintenance organization</li>
